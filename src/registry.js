// Based on https://github.com/koalazak/redis-registry
...
module.exports = function (opts) {
    ...
    var leave = function (list, cb) {
        var loop = function () {
            ...
            if (!next) return cb instanceof Function ? cb() : noop();
    ...
    // graceful shutdown is not possible in original repository
    that.quit = function () {
        store.quit();
    };
